...
const seedData = async () => {
  try {
    ...
    console.log("Cleared existing User, CourseCategory, and Course records.");
    ...
    console.log(`Successfully created 1 Admin, ${enterpriseUsers.length} Enterprise, and ${studentsData.length} Student accounts.`);
    ...
    console.log(`Successfully created ${seededCategories.length} Course Categories.`);
    ...
    console.log(`Successfully created ${coursesData.length} Sample Courses.`);
