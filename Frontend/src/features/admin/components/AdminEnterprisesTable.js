    ...
    <Box sx={{ width: '100%' }} className='enaterpriseCourseWrap'>
      ...
      <Modal open={confirmApprove} onClose={modalApproveClose} aria-labelledby='modal-modal-title'>
        <Box sx={modalStyle}>
          ...
          <Button variant='default' onClick={() => modalApproveClose()} className='me-3 mt-3 common-btn border-0'>
            Cancel
          </Button>
          <Button variant='default' onClick={() => approveEnterprise(enterpriseId)} className=' mt-3 border-0 bg-success'>
            Approve
          </Button>
        </Box>
      </Modal>
