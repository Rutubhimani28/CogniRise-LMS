  ...
  return (
    <div>
      ...
      <div className='d-flex justify-content-end pt-4'>
        <Button variant='outlined' onClick={moduleClose} sx={{ mr: 2, color: '#7d9b17', borderColor: '#7d9b17', '&:hover': { borderColor: '#6b8514', backgroundColor: 'rgba(125, 155, 23, 0.04)' }, textTransform: 'none' }}>
          Cancel
        </Button>
