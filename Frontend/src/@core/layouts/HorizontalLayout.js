...
const HorizontalLayout = props => {
  ...
  const layoutCustomBG = horizontalLayoutProps?.pageBG
  let userAppBarStyle = {}
  ...
  return (
    <HorizontalLayoutWrapper className='layout-wrapper'>
      <MainContentWrapper
        className={'layout-content-wrapper ' + layoutCustomBG}
      ...
      >
            ...
            >
              ...
              >
                <AppBarContent
                  ...
                  appBarContent={horizontalLayoutProps?.appBar?.content} //menu
        ...
        {scrollToTop ? (
          ...
          <ScrollToTop className='mui-fixed'>
            <Fab className='bg-custom-brown' size='small' aria-label='scroll back to top'>
              <Icon icon='tabler:arrow-up' className='text-black' />
            </Fab>
          </ScrollToTop>
        )}
      </MainContentWrapper>
